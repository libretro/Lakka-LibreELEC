...
if [ "$UBOOT_VERSION" = "imx6-cuboxi" ]; then
  ...
  PKG_COMMIT="77b8f0b"
  PKG_VERSION="imx6-$PKG_COMMIT"
  PKG_SITE="https://github.com/wandboard-org/uboot-imx"
  PKG_URL="https://github.com/wandboard-org/uboot-imx/archive/$PKG_COMMIT.tar.gz"
  PKG_SOURCE_NAME="$PKG_NAME-wb-$PKG_VERSION.tar.gz"
  PKG_SOURCE_DIR="uboot-imx-${PKG_COMMIT}*"
