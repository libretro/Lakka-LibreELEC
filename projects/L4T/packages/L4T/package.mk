...
PKG_URL=""
PKG_DEPENDS_TARGET="freetype libdrm pixman $OPENGL libepoxy glu retroarch $LIBRETRO_CORES alsa-plugins alsa-ucm-conf libdrm libXext libXdamage libXfixes libXxf86vm libxcb libX11 libXrandr retroarch:target tegra-bsp"
...
if [ "$DEVICE" == "Switch" ]; then
  PKG_DEPENDS_TARGET+=" joycond mergerfs rewritefs xdotool switch-cpu-profile switch-gpu-profile"
fi
