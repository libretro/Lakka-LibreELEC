...
>&2 echo "S802.arm"
DISTRO=Lakka PROJECT=S802 DEVICE=S82 ARCH=arm make image -j9
DISTRO=Lakka PROJECT=S802 DEVICE=M8 ARCH=arm make image -j9
DISTRO=Lakka PROJECT=S802 DEVICE=T8 ARCH=arm make image -j9
DISTRO=Lakka PROJECT=S802 DEVICE=MXIII-1G ARCH=arm make image -j9
>&2 echo "S805.arm"
DISTRO=Lakka PROJECT=S805 DEVICE=HD18Q ARCH=arm make image -j9
DISTRO=Lakka PROJECT=S805 DEVICE=M201C ARCH=arm make image -j9
DISTRO=Lakka PROJECT=S805 DEVICE=MK808B-Plus ARCH=arm make image -j9
DISTRO=Lakka PROJECT=S805 DEVICE=MXQ ARCH=arm make image -j9
