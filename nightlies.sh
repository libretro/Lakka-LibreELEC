...
DISTRO=Lakka PROJECT=Generic ARCH=x86_64 make image -j6
>&2 echo "Generic.i386"
DISTRO=Lakka PROJECT=Generic ARCH=i386 make image -j6
>&2 echo "RPi.arm"
DISTRO=Lakka PROJECT=RPi ARCH=arm make image -j6
>&2 echo "RPi.arm noobs"
DISTRO=Lakka PROJECT=RPi ARCH=arm make noobs -j6
>&2 echo "RPi2.arm"
DISTRO=Lakka PROJECT=RPi2 ARCH=arm make image -j6
>&2 echo "RPi2.arm noobs"
DISTRO=Lakka PROJECT=RPi2 ARCH=arm make noobs -j6
>&2 echo "imx6.cuboxi.arm"
DISTRO=Lakka PROJECT=imx6 SYSTEM=cuboxi ARCH=arm make image -j6
>&2 echo "imx6.udoo.arm"
DISTRO=Lakka PROJECT=imx6 SYSTEM=udoo ARCH=arm make image -j6
