...
Section "oeusbstart"
  ...
  ${WriteToFile} '$DRIVE_LETTER\syslinux.cfg' 'MENU TITLE OpenELEC Boot Menu'
  ...
  ${WriteToFile} '$DRIVE_LETTER\syslinux.cfg' 'MENU MARGIN 4'
  ${WriteToFile} '$DRIVE_LETTER\syslinux.cfg' 'MENU ROWS 5'
  ${WriteToFile} '$DRIVE_LETTER\syslinux.cfg' 'MENU VSHIFT 10'
  ${WriteToFile} '$DRIVE_LETTER\syslinux.cfg' 'MENU TIMEOUTROW 13'
  ${WriteToFile} '$DRIVE_LETTER\syslinux.cfg' 'MENU TABMSGROW 11'
  ${WriteToFile} '$DRIVE_LETTER\syslinux.cfg' 'MENU CMDLINEROW 11'
  ${WriteToFile} '$DRIVE_LETTER\syslinux.cfg' 'MENU HELPMSGROW 16'
  ${WriteToFile} '$DRIVE_LETTER\syslinux.cfg' 'MENU HELPMSGENDROW 29'
  ${WriteToFile} '$DRIVE_LETTER\syslinux.cfg' ''
  ${WriteToFile} '$DRIVE_LETTER\syslinux.cfg' 'MENU COLOR border       30;44   #40ffffff #a0000000 std'
  ${WriteToFile} '$DRIVE_LETTER\syslinux.cfg' 'MENU COLOR title        1;36;44 #9033ccff #a0000000 std'
  ${WriteToFile} '$DRIVE_LETTER\syslinux.cfg' 'MENU COLOR sel          7;37;40 #e0ffffff #20ffffff all'
  ${WriteToFile} '$DRIVE_LETTER\syslinux.cfg' 'MENU COLOR unsel        37;44   #50ffffff #a0000000 std'
  ...
  ${WriteToFile} '$DRIVE_LETTER\syslinux.cfg' 'MENU COLOR tabmsg       31;40   #30ffffff #00000000 std'
  ${WriteToFile} '$DRIVE_LETTER\syslinux.cfg' ''
  ${WriteToFile} '$DRIVE_LETTER\syslinux.cfg' 'LABEL installer'
  ${WriteToFile} '$DRIVE_LETTER\syslinux.cfg' '  MENU LABEL Run Installer'
  ...
  ${WriteToFile} '$DRIVE_LETTER\syslinux.cfg' '  MENU LABEL Run Live USB'
  ${WriteToFile} '$DRIVE_LETTER\syslinux.cfg' '  KERNEL /KERNEL'
  ${If} $STORAGE_SIZE == "0"
